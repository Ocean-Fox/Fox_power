...
void Pid_Init(void)
{
	...
	PID_init(&imu_pid_power_buck,			0.009	,35 / 200000.0	,4e-06* 200.0	,3,2.9		,-3,-3);
	PID_init(&imu_pid_power_boost,			0.01	,35 / 200000.0	,4e-06* 200.0	,3,2.9		,-3,-3);
	PID_init(&imu_pid_power_buck_boost_mix, 0.0065	,9/ 200000.0	,3.3e-07* 200.0	,1,1		,-1,-1);
	PID_init(&imu_pid_vel_buck ,			0.03	,200 / 200000.0	,8e-06* 200.0	,0.75,0.6		,0.1,-1);
	PID_init(&imu_pid_vel_boost ,			0.03	,200 / 200000.0	,8e-06* 200.0	,0.75,0.6		,0.1,-1);
	PID_init(&imu_pid_vel_buck_boost_mix ,	0.03	,200 / 200000.0	,8e-06* 200.0	,0.75,0.6		,0.05,-1);
	PID_init(&imu_pid_cur_buck ,			0.007	,64 / 200000.0	,8.7e-07* 200.0	,0.75,0.6		,0.2,-1);
	PID_init(&imu_pid_cur_boost ,			0.007	,64 / 200000.0	,8.7e-07* 200.0	,0.75,0.6		,0.2,-1);
	PID_init(&imu_pid_cur_buck_boost_mix ,	0.01	,68 / 200000.0	,1.3e-06* 200.0	,0.75,0.6		,0.2,-1);
}
