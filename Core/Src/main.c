...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	vofa_begin();
//  __HAL_HRTIM_SETCOMPARE(&hhrtim1, HRTIM_TIMERINDEX_TIMER_B, HRTIM_COMPAREUNIT_1, (uint32_t)HRTIM_DMA_Buffer[2]);
//  __HAL_HRTIM_SETCOMPARE(&hhrtim1, HRTIM_TIMERINDEX_MASTER, HRTIM_COMPAREUNIT_2, (uint32_t)HRTIM_DMA_Buffer[1]);
//  __HAL_HRTIM_SETCOMPARE(&hhrtim1, HRTIM_TIMERINDEX_TIMER_A, HRTIM_COMPAREUNIT_1, (uint32_t)HRTIM_DMA_Buffer[0]);
...
//	HAL_HRTIM_WaveformCounterStart_DMA(&hhrtim1,  HRTIM_TIMERID_MASTER |HRTIM_TIMERID_TIMER_A | HRTIM_TIMERID_TIMER_B);
//	HAL_HRTIM_WaveformCounterStart_DMA(&hhrtim1, HRTIM_TIMERID_TIMER_A | HRTIM_TIMERID_TIMER_B);
...
//	float speed_up =0.05;
  ...
  {
//	  speed_up +=0.01f;
//	  if(speed_up >=0.5f)speed_up =0.5f;
//	  uint8_t maxs[3]={1,1,1};
//	  FDCAN3_Send_Msg(0x201,maxs);
...
//	  __HAL_TIM_SetCompare(&htim5, TIM_CHANNEL_4, 10000);
//	  
