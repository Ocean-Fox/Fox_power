...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, RGB_B_Pin|RGB_R_Pin|RGB_G_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PB1 PB2 PB10 PB14
                           PB15 PB5 PB8 PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_14
